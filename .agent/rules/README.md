...
| # | 에이전트 | 파일 | 역할 | 주요 산출물 |
|---|---------|------|------|-----------|
| 1 | 기획 Agent | `01-pm-agent.md` | 요구사항 정의 및 문서화 | 요건정의서, TC, DataDictionary |
...
| 6 | Artifact Manager | `06-artifact-manager.md` | 산출물 관리 및 메타데이터 관리 | 산출물 인덱스, metadata.json, DataDictionary |
